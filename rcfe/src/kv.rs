...
use rcfe_core::etcdserverpb::{CompactionRequest, CompactionResponse, DeleteRangeRequest, DeleteRangeResponse, PutRequest, PutResponse};
...
impl KVClient for DefaultKVClient {
    ...
    async fn compact_with_request(&mut self, request: CompactionRequest) -> Result<Response<CompactionResponse>, Error> {
